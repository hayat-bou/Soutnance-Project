              ...
              <div className="space-y-4">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-white">hayatbm02@gmail.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-white">+212(639024128)</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-white">42 Afrag , Tiznit Maroc</p>
                  </div>
                </div>
              </div>
              ...
              <div className="pt-4">
                ...
                <div className="flex flex-wrap space-x-4">
                  {['instagram'].map((social) => (
                    ...
                    <a href="https://www.instagram.com/hayat_boulzam_/" className="text-gray-500 hover:text-orange-500 transition-colors">
                   ...
                   <a href="https://www.linkedin.com/in/hayat-boulzam-422a69222/" className="text-gray-500 hover:text-orange-500 transition-colors">
